package com.example.Language_Learning_App.Config;
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        return new CorsConfigurationSource(){
            ...
            public CorsConfiguration getCorsConfiguration(HttpServletRequest request){
                ...
                cors.setAllowedOrigins(Arrays.asList("http://localhost:8080","http://localhost:3000,http://localhost:8081")); // which origins are allowed // * means all origins are allowed
